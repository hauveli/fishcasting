...
import static hauveli.fishcasting.Fishcasting.MODID;
...
public class FishcastingConfig implements ConfigData {
    ...
    public static class Gameplay {
        ...
        private boolean lengthPurificationOnlyFish = true;
        // Stadiometer's purification already exists!
        // So at the very least, balancing isn't a major concern...
        // thanks to input on hexcord I at least should consider this for the future:
        // futures:
        // Hex implements this feature in base:
        // -> I keep the behavior and it also works on fish
        // -> I keep the behavior but it doesn't work on fish -> I need a custom pattern
        // Hex doesn't implement this feature in base:
        // -> I keep the behavior and it also works on fish
        // -> I keep the behavior and it only works on fish
        // if I add a custom pattern, I'm OK for any future. if not, I am boned in at least one future.
