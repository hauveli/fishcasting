...
typealias RegistrarEntry<T> = FishcastingRegistrar<T>.Entry<out T>

abstract class FishcastingRegistrar<T : Any>(
    ...
    fun <V : T> register(name: String, builder: () -> V): Entry<V> = register(Fishcasting.id(name), builder)
