...
import hauveli.fishcasting.casting.recipe.lightning.StruckByLightningIngredient
...
object StruckByLightningProcessor : IComponentProcessor {
        ...
        when (key) {
            "entityIn" -> {
                if (this.exampleEntityList == null) {
                    val entities = this.recipe!!.entityIn.exampleEntities(Minecraft.getInstance().level)
